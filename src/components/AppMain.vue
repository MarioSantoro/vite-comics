...
<script>
import AppSectionBlue from './AppSectionBlue.vue';
    ...
    data() {
        return {
            listCards: [
                ...
                {
                    "thumb": "https://www.panini.it/media/catalog/product/cache/a5b5ddbc1qk55vk7wjgzg3pmxlh59rv5dlgewd9jem5nrt4w/M/1/M1BLLA015ISBN_0.jpg",
                    "price": "$3.99",
